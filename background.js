...
const mockLLMResponse = {
  annotations: [
    ...
    { category: "good-question", textToHighlight: "How do we balance the benefits of a connected world with the fundamental right to privacy?", comment: "Given the focus on connectivity, has the author considered the impact of digital divide on equitable access?" },
    ...
    { category:a "bias-tracker", textToHighlight: "Everyone agrees that", comment: "This is an example of the 'bandwagon effect' bias.", severity: 1 },
